...
class _SplashCanvas extends CustomPainter {
  ...
  ui.Image? imageCanvas;
   ...
   _SplashCanvas(this.imageCanvas);

  @override
  void paint(Canvas canvas, Size size) {
    final paint = Paint();

    paint.color = ColorsSelect.splashColor;
    ...
    paint2.color = ColorsSelect.splashColor;
    ...
    canvas.drawImage(imageCanvas!, const Offset(145 * 2.5, 270 * 3.0), paint);
  }
